...
public class PacienteAdapter
     extends RecyclerView.Adapter<PacienteAdapter.CustomAdapterViewHolder>
     ...
     */
    public PacienteAdapter(List<Paciente> dataSet, Activity act) {
    ...
    public class CustomAdapterViewHolder extends
        ...
        public CustomAdapterViewHolder(View view) {
             ...
             * implementado.
             * */
            txtItem.setOnClickListener(PacienteAdapter.this);
            btnExcluir.setOnClickListener(PacienteAdapter.this);
